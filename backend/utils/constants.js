...
export const BOOKING = {
  ...
  MAX_NIGHTS: 30, // Tối đa 30 đêm (1 tháng)
  MIN_NIGHTS: 1,
  MAX_ADVANCE_DAYS: 365, // Đặt trước tối đa 1 năm
};
...
/**
 * Error Messages - Standardized Vietnamese error messages
 */
...
/**
 * Success Messages - Standardized Vietnamese success messages
 */
...
/**
 * Check role hierarchy (user has required permission level)
 * @param {number} userRoleId - User's role ID
 * @param {number} requiredRoleId - Minimum required role ID
 * @returns {boolean}
 */
